...
export function LanguageSelector() {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 overflow-y-auto bg-[#f5f0e6] px-4 py-6 sm:px-6"
    >
      <div className="mx-auto flex min-h-full w-full max-w-4xl flex-col items-center">
        {/* Logo */}
        <motion.div
          initial={{ y: -10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.1 }}
          className="mb-6 w-full max-w-xs sm:max-w-sm"
        >
          <Image
        ...
        >
          <p className="text-lg font-medium text-[#1a1a1a]">Choisissez votre langue</p>
          <p
        ...
        >
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="text-base font-semibold text-[#1a1a1a]">Francais</p>
              <p className="text-xs text-[#6b6b6b]">Continuer en francais</p>
            </div>
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="text-base font-semibold text-[#1a1a1a]" style={{ fontFamily: 'var(--font-cairo), sans-serif' }}>
                العربية
              </p>
              <p className="text-xs text-[#6b6b6b]" style={{ fontFamily: 'var(--font-cairo), sans-serif' }}>
                المتابعة بالعربية
              </p>
            </div>
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#8B0000]/10 text-[#8B0000] transition-all group-hover:bg-[#8B0000] group-hover:text-white">
